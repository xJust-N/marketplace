...
public class LoginServlet extends HttpServlet {
    ...
    private static final int COOKIE_MAX_AGE =
            Integer.parseInt(AppProperties.getProperty("security.cookie-max-age-seconds", "3600"));
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            user = securityService.findUserBySessionId(sessionId).orElseThrow(
        ...
        resp.sendRedirect("%s/profile/%s".formatted(req.getContextPath(), user.getId()));
    }
}
